...
class ProjectDocumentType(Enum):
    ...
    RG_SW_TRASH_INSPECTION = 'ג10 הצהרה אחראי לביקורת על הפסולת'
    RG_SW_CHARGE_INSPECTION = 'ג1 מינוי אחראי לביקורת'
    RG_SW_CHARGE_STRACTURAL = 'ג3 מינוי אחראי לביצוע שלד'
    RG_SW_ADAPTER_AGREEMENT = 'מינוי אחראי לתיאום עם מכון בקרה'
    RG_SW_ANNOUN_INSPECTION = 'ג6 הצהרה אחראי לביקורת'
    RG_SW_ANNOUN_STRACTURAL = 'ג8 הצהרת אחרי שלד'
    RG_SW_ANNOUN_CONTRACTOR = 'ג9 הצהרת קבלן'
    RG_SW_CHARGE_CONTRACTOR = 'ג4 מינוי קבלן'
    RG_SW_ANNOUN_STABLE = 'הצהרת אחראי לבקורת ליציבות גדרות'
    RG_SW_MODED = 'ג12 אישור מודד'
    RG_SW_REQ_START_WORK = 'ג13 בקשה להתחלת עבודות'
    GENERAL = 'כללי'
