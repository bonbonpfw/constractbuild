...
class Project(Base):
    ...
    start_work_status = Column(String, nullable=True)
    start_work_date = Column(Date, nullable=True)
    start_work_target = Column(Date, nullable=True)
    eng_coord_contact_name = Column(String, nullable=True)
    coordination_status = Column(String, nullable=True)
    coordination_target_date = Column(Date, nullable=True)
